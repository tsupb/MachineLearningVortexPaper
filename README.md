...
- [main_TrainandTest.py](main_TrainandTest.py): This script can be used to train a model on a given sample set and then benchmark the model according to several parameters
- [main_Load.py](main_Load.py): This script can be used to load a model trained with main_TrainandTest.py and the test it on a separate set of samples
